...
`;Box.propTypes=BoxPropTypes,Box.defaultProps={borderWidth:"var(--border-thin)",invert:!1,padding:"var(--s1)"};var layouts_Box=Box;const CenterPropTypes={andText:prop_types_default.a.bool,gutters:prop_types_default.a.number,intrinsic:prop_types_default.a.bool,max:prop_types_default.a.string},Center=styled_components_browser_esm.b.div`
...
`;Frame.propTypes=FramePropTypes,Frame.defaultProps={ratio:"6:9"};var layouts_Frame=Frame;const GridPropTypes={min:prop_types_default.a.string,space:prop_types_default.a.string},Grid=styled_components_browser_esm.b.div`
  align-content: start;
  display: grid;
...
`;Grid.propTypes=GridPropTypes,Grid.defaultProps={min:"250px",space:"var(--s0)"};var layouts_Grid=Grid,react=__webpack_require__(0),react_default=__webpack_require__.n(react),es2015=__webpack_require__(350);const ReelPropTypes={height:prop_types_default.a.string,itemWidth:prop_types_default.a.string,overflowing:prop_types_default.a.bool,space:prop_types_default.a.string,thumbColor:prop_types_default.a.string,trackColor:prop_types_default.a.string},StyledReel=styled_components_browser_esm.b.div`
  display: flex;
